...
def word2vec(batch_gen):
    ...
    #loss = tf.nn.nce_loss(nce_weight, bias, outputs, inputs, num_sampled, num_classes, ...)
    ...
    with tf.Session() as sess:
        ...
        for index in xrange(NUM_TRAIN_STEPS):
            ...
            [_, loss_batch] = sess.run([optimizer, loss], feed_dict={X: centers, Y: targets})
